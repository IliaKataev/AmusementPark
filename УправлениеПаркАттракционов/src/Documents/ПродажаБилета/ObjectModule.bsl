...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Пока Выборка.Следующий() Цикл
		...
		ДвижениеффАктивныеПосещения = Движения.АктивныеПосещения.Добавить();
		ДвижениеффАктивныеПосещения.Период = Дата;
		ДвижениеффАктивныеПосещения.ВидДвижения = ВидДвиженияНакопления.Приход;
		ДвижениеффАктивныеПосещения.Основание = Ссылка;
		ДвижениеффАктивныеПосещения.ВидАттракциона = Выборка.ВидАттракциона;
		ДвижениеффАктивныеПосещения.КоличествоПосещений = Выборка.КоличествоПосещений;
